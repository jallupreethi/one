...
<head>
    ...
    <style>
        /* ----- ROOT VARIABLES (refreshed) ----- */
        :root {
            --bg: #f7f5f2;
            --bg-card: #ffffff;
            --primary: #1b1b2a;
            --primary-light: #2c2c44;
            --accent: #d66b4a;
            --accent-light: #f2dbd3;
            --accent-dark: #b84d30;
            --muted: #6b6b7a;
            ...
            --shadow-hover: 0 18px 48px rgba(0, 0, 0, 0.07);
        ...
        * {
        ...
        .btn-primary {
            ...
            box-shadow: 0 6px 20px rgba(214, 107, 74, 0.25);
        }
        .btn-primary:hover {
            background: var(--accent-dark);
            border-color: var(--accent-dark);
            transform: translateY(-3px);
            box-shadow: 0 12px 28px rgba(214, 107, 74, 0.35);
        }
        .btn-secondary {
        ...
        .btn-secondary:hover {
            ...
            transform: translateY(-3px);
            box-shadow: 0 12px 28px rgba(27, 27, 42, 0.2);
        }
        .btn-outline {
            background: transparent;
            color: var(--primary);
            border-color: rgba(27, 27, 42, 0.15);
        }
        .btn-outline:hover {
            background: var(--primary);
            color: #fff;
        ...
        header {
            ...
            border-bottom: 1px solid rgba(27, 27, 42, 0.03);
        }
        .header-inner {
            display: flex;
            align-items: center;
        ...
        #mobileMenu {
            display: none;
            background: #fff;
            border-top: 1px solid rgba(27, 27, 42, 0.03);
            padding: 12px 0 20px;
        }
        #mobileMenu ul {
            list-style: none;
        ...
        .hero {
            ...
            overflow: hidden;
            margin: 20px 24px 0;
            background: linear-gradient(145deg, #1e1e32 0%, #2a2a44 100%);
        }
        .hero::before {
            content: '';
            position: absolute;
        ...
        .hero .badge {
            ...
            background: rgba(214, 107, 74, 0.2);
            color: var(--accent);
            padding: 4px 18px;
            border-radius: 999px;
            font-weight: 600;
        ...
        /* ----- NEWSLETTER (warm) ----- */
        .newsletter-wrap {
            background: linear-gradient(145deg, var(--primary) 0%, #2f2f4a 100%);
            border-radius: var(--radius);
            padding: 44px 52px;
            color: #fff;
            display: flex;
