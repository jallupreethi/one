...
<head>
  ...
  <title>Nexus · dark edition</title>

  <!-- Fonts & Icons -->
  <link href="https://fonts.googleapis.com/css2?family=Inter:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&family=Playfair+Display:ital,wght@0,700;1,700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" crossorigin="anonymous">

  <style>
    /* ----- DARK ROOT (user‑friendly, high contrast) ----- */
    :root {
      --bg: #0d0d14;
      --bg-card: #191925;
      --bg-surface: #22223a;
      ...
      --shadow-hover: 0 18px 48px rgba(0, 0, 0, 0.8);
    ...
    * {
    ...
    .btn-primary {
      ...
      box-shadow: 0 6px 20px rgba(243, 156, 109, 0.25);
    }
    .btn-primary:hover {
      background: var(--accent-dark);
      border-color: var(--accent-dark);
      transform: translateY(-3px);
      box-shadow: 0 12px 28px rgba(243, 156, 109, 0.35);
      color: #0d0d14;
    }
    .btn-secondary {
    ...
    .search-wrap:focus-within {
      ...
      box-shadow: 0 0 0 4px rgba(243, 156, 109, 0.08);
    }
    .search-wrap input {
      border: 0;
      background: transparent;
    ...
    .mobile-toggle:hover { background: var(--accent-light); color: #0d0d14; }
    ...
    #mobileMenu ul li a:hover { background: var(--bg-surface); }
    ...
    .hero .badge {
      ...
      background: rgba(243, 156, 109, 0.15);
      color: var(--accent);
      padding: 4px 18px;
      border-radius: 999px;
      font-weight: 600;
    ...
    /* ----- NEWSLETTER (dark) ----- */
    .newsletter-wrap {
      background: linear-gradient(145deg, #181825 0%, #22223a 100%);
      border-radius: var(--radius);
      padding: 44px 52px;
      color: #fff;
      display: flex;
...
<body>
  ...
  <script>
    ...
    console.log('🌙 NexusShop · dark theme loaded.');
  </script>
